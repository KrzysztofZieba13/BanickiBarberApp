  ...
  deleteServiceConfirmBtn.addEventListener('click', async () => {
    try {
      const res = await axios({
        method: 'delete',
        url: `http://drkrzysztofzieba.usermd.net/api/v1/service/${serviceID}`,
      });
...
export const updateTablecost = async function (data, serviceID) {
  try {
    ...
    const res = await axios({
      method: 'patch',
      url: `https://drkrzysztofzieba.usermd.net/api/v1/service/${serviceID}`,
      data,
    });
...
export const addTablecost = async function (data) {
  try {
    ...
    const res = await axios({
      method: 'post',
      url: 'https://drkrzysztofzieba.usermd.net/api/v1/service/',
      data,
    });
